...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  const commands = {
    ...
    startSession: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:start-session",
      execute: (input: StartThreadSessionInput) => startThreadSession(input),
      scheduler,
      concurrency,
    }),
