...
export const GhosttyIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 24 24" fill="#3551F3">
...
export const NeovimIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 24 24" fill="#57A143">
    <path d="M2.214 4.954v13.615L7.655 24V10.314L3.312 3.845 2.214 4.954zm4.999 17.98-4.557-4.548V5.136l.59-.596 3.967 5.908v12.485zm14.573-4.457-.862.937-4.24-6.376V0l5.068 5.092.034 13.385zM7.431.001l12.998 19.835-3.637 3.637L3.787 3.683 7.43 0z" />
  </svg>
);
